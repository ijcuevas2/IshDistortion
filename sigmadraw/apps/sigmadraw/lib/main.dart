...
class _SigmaDrawHomeState extends State<SigmaDrawHome> {
  ...
  Future<void> _exportSvg() async {
    final path = await showDialog<String>(
      context: context,
      builder: (_) => ExportSvgDialog(document: _document),
    );
    if (path != null && mounted) {
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text('Exported to $path')));
      ...
      RibbonGroup(
        ...
        actions: [
          ...
          RibbonAction(
            ...
            label: 'SVG',
            tooltip: 'Export a plain, portable SVG (strips SigmaDraw data)',
                            ...
                            children: [
                              const TabBar(
                                ...
                                tabs: [
                                  ...
                                  Tab(text: 'Group Delay'),
                                  Tab(text: 'Impulse/Step'),
                                  Tab(text: 'Root Locus'),
                                ],
                              ),
                              Expanded(
                                child: TabBarView(
                                  children: [
                                    ...
                                    GroupDelayPanel(document: _document),
                                    ImpulseStepPanel(document: _document),
                                    RootLocusPanel(document: _document),
                                  ],
                                ),
                              ),
                            ],
