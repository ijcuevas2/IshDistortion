...
/// root-finding, and (§5.11) Bode magnitude/phase and Nyquist
/// complex-plane plots from the same H(z) evaluated around the unit
/// circle.
///
...
/// and the rest of §5.11's analysis plots (a spectrogram, which needs an
/// actual sampled signal to analyze rather than only a symbolic transfer
